...
public function getReservationDetails($idReservation) {
    $reservationDetails = $this->unModele->getReservationId($idReservation);
    $logementDetails = $this->unModele->getLogementId($reservationDetails['id_logement']);
    $clientDetails = $this->unModele->getClientId($reservationDetails['id_utilisateur']);
