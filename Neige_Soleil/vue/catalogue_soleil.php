...
<header  style="display: flex; justify-content: space-between;">
    ...
    <button onclick="window.location.href='catalogue_neige.php'">Allons au ski</button>
    <?php
    ...
    <h2> Soleil</h2>
    <center><p> "Vamos a la playa a mi me gusta bailar" Loana</p></center>
    <div class=reserve>
<?php
$controleur = new Controleur();
$controleur->setTable('logement');
$logementsSoleil = $controleur->selectLogementsBySoleil();

foreach ($logementsSoleil as $logement){
    echo '<div class="soleil">';
